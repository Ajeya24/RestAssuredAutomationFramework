...
public class SignUpRequest {
	...
	//Creating a inner class which in this case is a Builder class
	//Builder class does not have constructor inside it
	//Builder design pattern does not use void as a return type
	//Also the current object is returned for all functions in Builder Design Pattern
